...
namespace VillaSofia
{
    public partial class CduFacturacion : UserControl
    {
        ...
        void cargarPanelFacturas()
        {
            ...
            {
                DT = factura.mostrarFacturasparaPanel(DateTime.Now);
            }
            else
            {
                DT = factura.mostrarFacturasSinCancelarparaPanel(DateTime.Now);
        ...
        {
            ClsLogicaFactura factura = new ClsLogicaFactura();
            return factura.validarFacturasCanceladas(DateTime.Now);
        }
