    ...
    public partial class CduRegistroEvento2 : UserControl
    {
        ...
        private void txtNombre_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar != (char)Keys.Space)
            {
                ...
                {
                    MessageBox.Show("Solo se permiten letras, ingrese nuevamente los El nombre", "ERROR", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                    e.Handled = true;
                    return;
                }
            }
        ...
        private void txtPendiente_KeyPress(object sender, KeyPressEventArgs e)
        {
